...
import { IconTrash, IconEdit, IconPlus, IconRefresh, IconAlertCircle } from "@tabler/icons-react";
        ...
        <Stack gap="xl">
            ...
            <Box>
                ...
                {faqs.length === 0 && (
                    <Paper p="xl" style={{ textAlign: "center", backgroundColor: "#f8f9fa" }}>
                        <Text c="dimmed">No FAQs created yet. Use the button above to add your first FAQ.</Text>
                    </Paper>
                )}
            </Box>
            ...
            >
                <Stack gap="lg">
                    ...
                    <Group justify="flex-end" gap="sm">
                        <Button variant="subtle" color="gray" onClick={handleCancelDelete}>
                            Cancel
                        </Button>
