...
export default function RSVPFormPage() {
    ...
    const handleInviteeChange = (inviteeId: number, coming: boolean) => {
        setFormData(prev => ({
            ...prev,
            invitees: prev.invitees.map(inv => (inv.id === inviteeId ? { ...inv, coming } : inv)),
        }));
    };
                                    ...
                                    <Stack gap="xl">
                                        ...
                                        <Box mb="xl">
                                            ...
                                            <Radio.Group
                                                ...
                                                onChange={value =>
                                                    setFormData(prev => ({ ...prev, coming: value === "yes" }))
                                                }
                                                required
                                            >
                                                <Group gap="lg">
                                                ...
                                                */}
                                                ...
                                                <Box mb="xl">
                                                    ...
                                                    <Radio.Group
                                                        ...
                                                        onChange={value =>
                                                            setFormData(prev => ({ ...prev, own_accomodation: value }))
                                                        }
                                                        required
                                                    >
                                                        <Group gap="lg">
                                                ...
                                                <Box mb="xl">
                                                    ...
                                                    <Textarea
                                                        ...
                                                        onChange={e =>
                                                            setFormData(prev => ({
                                                                ...prev,
                                                                dietary_restrictions: e.currentTarget.value,
                                                            }))
                                                        }
                                                        minRows={3}
                                                        size="md"
                                                ...
                                                <Box mb="xl">
                                                    ...
                                                    <Textarea
                                                        ...
                                                        onChange={e =>
                                                            setFormData(prev => ({
                                                                ...prev,
                                                                song_request: e.currentTarget.value,
                                                            }))
                                                        }
                                                        minRows={2}
                                                        size="md"
                                                ...
                                                <Box mb="xl">
                                                    ...
                                                    <Textarea
                                                        ...
                                                        onChange={e =>
                                                            setFormData(prev => ({
                                                                ...prev,
                                                                travel_plans: e.currentTarget.value,
                                                            }))
                                                        }
                                                        minRows={3}
                                                        size="md"
                                        ...
                                        <Box mb="xl">
                                            ...
                                            <Textarea
                                                ...
                                                onChange={e =>
                                                    setFormData(prev => ({ ...prev, message: e.currentTarget.value }))
                                                }
                                                minRows={3}
                                                size="md"
                                            />
                                        ...
                                        {/* Submit Button */}
                                        <Button type="submit" size="lg" loading={submitting} color="#8b7355" fullWidth>
                                            Submit RSVP
                                        </Button>
                                    </Stack>
                                </form>
