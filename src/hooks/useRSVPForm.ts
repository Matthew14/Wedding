...
export const useRSVPForm = () => {
    const form = useForm<RSVPFormData>({
        ...
        validate: {
            accepted: (value) => (value === undefined || value === null ? "Please select whether you're coming" : null),
            ...
            staying_villa: (value) => (value === undefined || value === null ? "Please select accommodation preference" : null),
